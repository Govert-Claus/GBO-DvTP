...
Zoals in de contextdiagram wordt geschetst worden de gegevens van de bronhouder via het DvTP/GBO stelsel voor drie doelen gebruikt. Dit ontlast de bronhouder en maakt hergebruik van gegevens eenvoudiger. Ook als er meer doelen bijkomen vormt deze opzet een oplossing die hergebruikt kan worden.
